...
const BottomNav: React.FC<BottomNavProps> = ({ currentRoute, onNavigate }) => {
  ...
  return (
    <div className="absolute bottom-0 left-0 right-0 z-40 pb-safe pointer-events-none flex justify-center">
      <div className="mb-6 px-4 w-full max-w-lg pointer-events-auto">
